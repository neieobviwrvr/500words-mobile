# -*- coding: utf-8 -*-
"""dating_romance auf Schwedisch: die ersten zwei Saetze der Kategorie.
...
SAETZE = [
 dict(de='Hast du einen festen Freund oder eine feste Freundin?', sv='Har du pojkvän eller flickvän?',
      k=[('fester_partner', ['pojkvän', 'flickvän'])]),
 dict(de='Wir sind gerade zusammen.', sv='Vi är tillsammans.',
      k=[('daten', ['tillsammans', 'är tillsammans'])]),
]
