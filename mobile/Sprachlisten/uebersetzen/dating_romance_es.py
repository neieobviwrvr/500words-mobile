# -*- coding: utf-8 -*-
"""dating_romance auf Spanisch: die ersten zwei Saetze der Kategorie.
...
SAETZE = [
 dict(de='Hast du einen festen Freund oder eine feste Freundin?', es='¿Tienes novio o novia?',
      k=[('fester_partner', ['novio', 'novia'])]),
 dict(de='Wir sind gerade zusammen.', es='Estamos juntos.',
      k=[('daten', ['estamos juntos', 'juntos', 'saliendo'])]),
]
